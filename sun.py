...
def ccW(startPos, endPos, targetPos):
    slopeACNumerator = targetPos[1] - startPos[1]
    slopeACDenominator = targetPos[0] - startPos[0]
    
    slopeABNumerator = endPos[1] - startPos[1]
    slopeABDenominator = endPos[0] - startPos[0]
    
    return slopeACNumerator*slopeABDenominator > slopeABNumerator*slopeACDenominator
